...
#define TEMPERATUURSENSORPIN 5
#define ZUURSTOFSENSORPIN 5
#define PHSENSORPIN 5
#define TROEBELHEIDSENSORPIN 5
#define ELEKTRISCHEGELEIDINGSSENSORPIN 5
...
// network.
static const PROGMEM u1_t NWKSKEY[16] = { 0xF6, 0x28, 0xC3, 0x76, 0xC9, 0x49, 0x27, 0x97, 0x65, 0x08, 0x16, 0x1E, 0xEB, 0xC1, 0xB8, 0x84 };

// LoRaWAN AppSKey, application session key
// This is the default Semtech key, which is used by the early prototype TTN
// network.
static const u1_t PROGMEM APPSKEY[16] = { 0xE2, 0x1B, 0x6D, 0xC2, 0x24, 0x45, 0xD0, 0xAD, 0x59, 0xC9, 0x79, 0x54, 0xBD, 0x45, 0x9B, 0x62 };

// LoRaWAN end-device address (DevAddr)
static const u4_t DEVADDR = 0x260B3E39;  // <-- Change this address for every node!
